...
namespace TextIdVisualiser.Options
{
    ...
    [ProvideOptionPage(typeof(DialogPageProvider.General), "TextIdVisualiser", "General", 0, 0, true)]
    ...
    public sealed class OptionsPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "3a6ec384-f73c-48c6-ae3b-7875dbb0e729";
